...
4. what is SGD (stochastic gradient descent) in terms of optimizers?
    - SGD looks at just one random data point, or a small batch, then updates the model 
    weights. this makes it faster per step than evaluating the whole dataset